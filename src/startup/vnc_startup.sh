...
echo "
USAGE:
docker run -it -p 6901:6901 -p 5901:5901 automation:<tag> <option>
...
-s, --skip      skip the vnc startup and just execute the assigned command.
                example: docker run automation --skip bash
-d, --debug     enables more detailed startup output
                e.g. 'docker run automation --debug bash'
-h, --help      print out this help

Fore more information see: https://github.com/neoskx/automation
"
}
if [[ $1 =~ -h|--help ]]; then
    help
